            ...
            <div class="p-6 space-y-8">
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-500">
                    Recommended size: 800x450 pixels. This will be displayed in the course.
                  </p>
                </div>
...
const visibilityOptions = [
  {
    value: 'public',
    label: 'Public',
    description: 'Visible to all students in course'
  },
  {
    value: 'private',
    label: 'Private',
...
const submit = async () => {
  ...
  try {
    ...
    // Submit the form
    await router.post(route('admin.courses.store'), formData, {
      preserveScroll: true,
      onSuccess: (response) => {

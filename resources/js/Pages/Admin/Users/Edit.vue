...
const form = useForm({
  ...
  // Student profile
  exam_board_id: props.user.student_profile?.exam_board_id || '',
  current_level: props.user.student_profile?.current_level || 'beginner',
  target_level: props.user.student_profile?.target_level || 'intermediate',
  target_completion_date: props.user.student_profile?.target_completion_date || '',
  weekly_study_hours: props.user.student_profile?.weekly_study_hours || '5',
  current_grade: props.user.student_profile?.current_grade || '',
  target_grade: props.user.student_profile?.target_grade || '',
  learning_goals: props.user.student_profile?.learning_goals || [],
  learning_preferences: props.user.student_profile?.learning_preferences || [],
})

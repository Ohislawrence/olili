                  ...
                  <div class="bg-gray-50 px-5 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                      ...
                      <div class="text-sm text-gray-500">
                        {{ module.topics?.length || 0 }} topics • {{ module.estimated_duration_minutes < 60 ? module.estimated_duration_minutes + 'm' : Math.ceil(module.estimated_duration_minutes / 60) + 'h' }}
                      </div>
                    </div>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
              ...
              <div class="space-y-3">
                ...
                <div v-if = "course.has_certificate" class="flex items-center text-sm text-gray-600">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">

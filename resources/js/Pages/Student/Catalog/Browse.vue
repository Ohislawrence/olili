<!-- resources/js/Pages/Student/Catalog/Browse.vue -->
<template>
  <StudentLayout>
    <Head title="Course Catalog" />

    <div class="py-6" v-if="courses">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-xs text-emerald-600">
                  {{ enrolled_course_ids?.length || 0 }} courses already enrolled • Browse all available courses
                </p>
              </div>
            </div>
          </div>
        ...
        <!-- Courses Grid -->
        <div v-if="courses.data && courses.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
          ...
          >
            ...
            <div class="h-48 bg-gradient-to-br from-emerald-100 to-teal-100 relative">
              ...
              <div class="absolute bottom-3 left-3">
                <span :class="getLevelBadgeClass(course.level)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize">
                  {{ course.level }}
                </span>
              </div>
            </div>
            ...
            <div class="p-5">
              ...
              <div class="space-y-3">
                ...
                <div v-if="course.enrollment_limit" class="flex items-center text-sm text-gray-500">
                  ...
                  <span class="flex-1">
                    {{ course.current_enrollment || 0 }} / {{ course.enrollment_limit }} spots
                  </span>
              ...
              <div class="mt-6">
                ...
                <div v-else>
                  <div class="space-y-2">
                    ...
                    >
                      <svg v-if="enrollingCourseId !== course.id" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Pagination -->
        <div v-if="courses.links && courses.links.length > 3" class="mt-8">
...
const updateFilters = () => {
  router.get(route('student.catalog.browse'), filters, {
    preserveState: true,
    replace: true,
  })
}
...
const enrollCourse = async (course) => {
  if (enrollingCourseId.value) return // Prevent multiple clicks
  ...
  try {
    await router.post(route('student.courses.enroll', course.id), {}, {
      ...
      preserveState: true,
      onSuccess: () => {
        // Force a reload to get updated enrollment status

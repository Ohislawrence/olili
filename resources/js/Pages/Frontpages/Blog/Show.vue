                ...
                <div class="flex flex-col lg:flex-row gap-12">
                    ...
                    <article class="lg:w-2/3">
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200">
                            <h4 class="text-lg font-semibold text-gray-900 mb-4">Share this knowledge</h4>
                            <div class="flex space-x-4">
                            <!-- Twitter Share -->
                            <button 
                                @click="shareOnTwitter"
                                class="p-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors shadow-sm hover:shadow-md"
                            ...
                            <button 
                                ...
                                class="p-3 bg-blue-800 text-white rounded-xl hover:bg-blue-900 transition-colors shadow-sm hover:shadow-md"
                            ...
                            <button 
                                ...
                                class="p-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors shadow-sm hover:shadow-md"
                            ...
                            <button 
                                ...
                                :class="[
                                'p-3 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors shadow-sm hover:shadow-md',
                            ...
                            <!-- Success Message -->
                            <div v-if="copySuccess" class="mt-3 p-2 bg-green-100 border border-green-400 text-green-700 rounded text-sm transition-opacity duration-300">
...
const currentUrl = props.blogUrl || window.location.href
const currentTitle = props.post.title || document.title
...
// Alternative: Use Web Share API if available (for mobile devices)

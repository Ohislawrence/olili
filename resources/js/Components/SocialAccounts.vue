<!-- resources/js/Components/SocialAccounts.vue -->
<template>
    <div class="bg-white shadow rounded-lg p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Connected Social Accounts</h3>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                ...
                <a 
                    ...
                    class="px-4 py-2 text-sm font-medium text-emerald-600 hover:text-emerald-700 transition-colors"
                >
                    Connect
                </a>
            </div>
...
const unlinkAccount = (provider) => {
    if (confirm(`Are you sure you want to unlink your ${provider} account?`)) {
        form.post(route('social.unlink', { provider }));
    }
};
</script>